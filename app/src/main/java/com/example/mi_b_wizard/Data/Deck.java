...
public class Deck {
    ...
    //getCards method takes the input currentRound, to generate a List<String> with the number of random cards equal to current Round

    public List<String> getCards(int currentRound) {
        ...
        while (i < currentRound) {
            ...
            HandCards.add(c);                                       //add Card to List<String> HandCards
            i++;
        }
        return HandCards;
    }
   ...
   /* public static void main(String[] args) {
    ...
    card.put(zauberer4.getId(),zauberer4);
        ...
        while (i < 5) {
            ...
            //System.out.println(card.get(key));
